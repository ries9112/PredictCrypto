...
#'@export
calculate_perc_change_investingdotcom <- function (coin_metrics, enter_hours)
{
  ...
  joinedDataset <- dplyr::left_join(coin_metrics, coin_metricsHLater, by = c("pkey",'exchange'))
