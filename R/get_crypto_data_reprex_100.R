...
#'@export
get_crypto_data_reprex_100 <- function(){

  # register pins board
  pins::board_register("https://raw.githubusercontent.com/predictcrypto/pins/master/",'reprex_bitgur_100')
  # convert names to snake_case
  reprex_data <- janitor::clean_names(pins::pin_get('reprex_bitgur_100','reprex_bitgur_100'))
  # convert date/time
