...
#'@export
get_crypto_data_reprex_10 <- function(){

  # register pins board
  pins::board_register("https://raw.githubusercontent.com/predictcrypto/pins/master/",'reprex_bitgur_10')
  # convert names to snake_case
  reprex_data <- janitor::clean_names(pins::pin_get('reprex_bitgur_10','reprex_bitgur_10'))
  # convert date/time
