...
#'@export
get_crypto_data_reprex_BTC <- function(){

  # register pins board
  pins::board_register("https://raw.githubusercontent.com/predictcrypto/pins/master/",'reprex_bitgur_BTC')
  # convert names to snake_case
  reprex_data <- janitor::clean_names(pins::pin_get('reprex_bitgur_BTC','reprex_bitgur_BTC'))
  # convert date/time
